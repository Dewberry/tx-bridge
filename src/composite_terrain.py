...
def fn_composite_terrain(str_input_path,str_small_dem_dir_path,str_output_dir,str_output_dem_name):
    ...
    if len(list_files) > 0:
        ...
        # open the base dem
        xds_base_to_match = rioxarray.open_rasterio(str_input_path)
        list_xds_rasters = []
        ...
        for str_current_small_raster in tqdm(list_files,
            ...
            xds = rioxarray.open_rasterio(str_current_small_raster)
        ...
        xds_merge = xds_merge.rio.write_crs("EPSG:4326")  # TODO: update
